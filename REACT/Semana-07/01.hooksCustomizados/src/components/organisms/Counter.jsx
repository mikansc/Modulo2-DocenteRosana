...
// com custom hook, mas com incremento sempre de 1 em 1
// não é muito útil, pois o valor inicial é fixo
export const Counter1 = () => {
  const [count, increment, decrement] = useCounter1();
  const [count2, increment2, decrement2] = useCounter1();

  return (
    <section className="flex-column flex-center gap-4">
      <h3>Contador COM custom hook - de   1 em 1, mas valor inicial que muda</h3>
      <div className="flex-center gap-16">
        <button className="p-8" onClick={decrement} >-</button>
        <span>{count}</span>
        <button className="p-8" onClick={increment}>+</button>
...
export const Counter2 = () => {
  const [count, increment, decrement] = useCounter2(); // valores padrão: valor inicial = 0, incremento = 1, decremento = 1
  const [count2, increment2, decrement2] = useCounter2(100, 2, 5);
...
export const Counter3 = () => {
  const [count, increment, decrement] = useCounter3(); // valor inicial padrão: 0
